...
class EventsDatabase(context: Context) {
    ...
    private val color1 = ContextCompat.getColor(context, R.color.colorPrimaryDark)
    private val color2 = ContextCompat.getColor(context, R.color.colorAccent)
    private val color3 = ContextCompat.getColor(context, R.color.confirm)
    private val color4 = ContextCompat.getColor(context, R.color.inProgress)
