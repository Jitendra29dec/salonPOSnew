...
public class AddProduct {
   ...
   // private final String businessUse;
    ...
    StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.addProduct, new Response.Listener<String>() {
        @Override
        public void onResponse(String response) {
            ...
            try {
                ...
                if (status.equalsIgnoreCase("1")) {
                    apiCommunicator.getApiData("product_added", jsonObject.getString("message"));
                } else {
    ...
    public AddProduct(ApiCommunicator apiCommunicator, String vendorId, String barcodeID, String supplierId,String brandId, String categoryId, String productName, String sku, String descripyion, String retailPrice, String wholesalePrice, String photo, String lowQtyyWarning, String purchasePrice,
                      String quantity,String commission_percent,String commission_amount, String isTax,String businessUse,String tax) {
