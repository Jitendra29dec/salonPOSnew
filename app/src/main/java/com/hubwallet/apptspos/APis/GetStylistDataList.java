...
public class GetStylistDataList {
        ...
        public void onResponse(String response) {
            ...
            try {
                ...
                if (
                    ...
                    apiCommunicator.getApiData("get_stylist_data_list", response);
                }
    ...
    public GetStylistDataList(ApiCommunicator apiCommunicator, String vendorId) {
